...
const handleRequest = async (req, res) => {
    try {
        ...
        const staticLinks = [
            ...
            { url: 'hypnotherapy-services/overcome-anxiety-and-remove-phobias', changefreq: 'monthly', priority: 0.8 },
            { url: 'hypnotherapy-services/performance-hypnotherapy-tranceformd', changefreq: 'monthly', priority: 0.8 },
            { url: 'hypnotherapy-services/quit-smoking-with-hypnotherapy', changefreq: 'monthly', priority: 0.8 },
            { url: 'hypnotherapy-services/hypnosis-for-stress-management', changefreq: 'monthly', priority: 0.8 },
            { url: 'hypnotherapy-services/hypnosis-for-insomnia-and-sleep-disorders', changefreq: 'monthly', priority: 0.8 },
            { url: 'hypnotherapy-services/weight-loss-and-binge-eating', changefreq: 'monthly', priority: 0.8 },
            { url: 'hypnotherapy-services/treatment-for-ptsd-and-trauma', changefreq: 'monthly', priority: 0.8 },
            { url: 'hypnotherapy-services/hypnotherapy-for-depression-and-low-self-esteem', changefreq: 'monthly', priority: 0.8 },
            { url: 'hypnotherapy-services/performance-anxiety-and-stage-fright', changefreq: 'monthly', priority: 0.8 },
            { url: '/insights', changefreq: 'monthly', priority: 0.9 },
