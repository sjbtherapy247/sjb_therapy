export const servicesDescription = [
  {
    ...
    content: `<p><h4>Overcoming Anxiety and Removing Phobias<sup style='font-size: 12px'</h4></p>
      ...
      <p>With a personalised and empathetic approach, I create a safe and nurturing space where you can openly express your fears and concerns. By delving into your subconscious mind, we will work collaboratively to identify the underlying triggers and patterns that contribute to your anxiety and phobias. Together, we will rewrite the narrative, replacing fear with confidence, and doubt with resilience.</p>

      <p>Using proven hypnotherapy techniques tailored to your unique needs, we will guide your mind into a state of deep relaxation and heightened receptivity. In this receptive state, we will gently reframe negative beliefs, replacing them with positive, empowering suggestions. You will discover newfound strength and clarity as we dissolve the shackles of anxiety and phobias, allowing you to reclaim your life and thrive in any situation.</p>
  ...
  },
  {
    ...
    content: `<p><h4>Performance Hypnotherapy - TRANCEformd<sup style='font-size: 12px'</h4></p>
      ...
      <p>Whether you're a professional athlete seeking that extra edge, an aspiring enthusiast amatuer looking to enhance your skills, a business person looking to take your career to the next level, this tailored approach utilises a range of hypnotic techniques and phenomena to propel you beyond your previous limits and guide you to unparalleled performance.</p>

      <p>Hypnotherapy challenges the traditional notions surrounding sport psychology by providing an individualised and dynamic methodology that goes beyond visualisation and relaxation. The ultimate addition to your existing performance strategies, to optimise your performance and guide you towards newfound success in your athletic or business endeavors.</p>
      ...
      <p>Drawing inspiration from the renowned Dr. Milton H. Erickson, our TRANCEformd<sup>TM</sup> approach centers around your unique needs both on and off the field. A variety of challenges are addressed, including motivation issues, attitudinal barriers, fears, self-sabotage, distractions, rehabilitation anxiety and the pressure to perform. All interventions are customised to fit your individual circumstances, setting you on the path to even greater success.</p>
      ...
      <ol>
        ...
        <p> Break out of performance slumps and bounce back from injury fast through future progression. Harness the power of kinesthetic hypnosis to ignite newfound enjoyment, self-assurance, and performance. Imagine an athlete crystallising their performance goals to return to excellence with speed and ease.</p>
  ...
  },
  {
    ...
    <p><strong>"Hypnosis was over three times as effective as nicotine replacement"</strong></p>
    ...
    <p>Embrace freedom today and a smoke-free life forever more, through the power of clinical hypnotherapy. Together, we can help you break free from the chains of the smoking habit, instill confidence, resilience, and self-control, and show you how to pave the way for a brighter and healthier future.</p>
