...
export const blogTitle = [
  'Exploring the Profound Benefits of Hypnotherapy',
  'Unleashing Your Potential: How Hypnotherapy Can Help',
  'Overcoming Anxiety through Hypnotherapy: A Step-by-Step Guide',
  ...
  'Unleashing the Subconscious: Exploring Hypnotherapy and Psychotherapy for Deep Healing',
  'Enhancing Well-being: Combining Hypnotherapy and Psychotherapy for Holistic Therapy',
  'Exploring the Profound Benefits of Hypnotherapy',
  'Unleashing Your Potential: How Hypnotherapy Can Help',
  'Overcoming Anxiety through Hypnotherapy: A Step-by-Step Guide',
  'The Science Behind Hypnotherapy: Understanding the Mind-Body Connection',
...
export const description = [
  "Hypnotherapy has gained recognition for its ability to harness the mind-body connection. Let's explore the scientific basis behind this powerful therapeutic approach.",
