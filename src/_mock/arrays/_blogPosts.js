...
<div>
<img alt="research photo" height='300px' width='100%' style="object-fit:cover" src="/assets/images/${name}/${name}_post_01.jpg" />
</div>
...
<p><img alt="alt marketing"  height='300px' width='100%' style="object-fit:cover"  src="/assets/images/${name}/${name}_post_02.jpg" /></p>
